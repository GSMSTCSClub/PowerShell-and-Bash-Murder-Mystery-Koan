...
def run_script(problem_number, script_path):
    try:
        ...
        print(
            f"A fatal error occurred! This probably means your script couldn't even compile:\n{e}"
        )
        return False
...
while True:
    try:
        ...
        for line in problems_list.splitlines():
            ...
            print(line)
        choice = input(
            "Choose a problem number to access (or m for the final challenge): "
        )
        if choice == "m":
            if all(correct_status[i] for i in range(1, 7)):
                ...
                while True:
                    response = input(
                        "What is the full name of the murderer? Include proper spacing and capitalization. (b to back)\n"
                    ).strip()
                ...
                try:
                    if choice != 6 and choice != 5:
                        ...
                        if choice2.lower() == "r":
                            if choice in [1, 2, 3]:
                                if os.path.exists(
                                    (selected_problem_path + "/Main.ps1")
                                ):
                                    if (
                                        run_script(
                                            choice, selected_problem_path + "/Main.ps1"
                                        )
                                        is True
                                    ):
                                        print("Correct!")
                                ...
                                if os.path.exists((selected_problem_path + "/Main.sh")):
                                    if (
                                        run_script(
                                            choice, selected_problem_path + "/Main.sh"
                                        )
                                        is True
                                    ):
                                        print("Correct!")
                        ...
                        if choice2.lower() == "r":
                            if (
                                not os.path.exists(
                                    "Problem 5/The records of a deranged Cybersecurity Officer"
                                )
                                and os.path.exists("Problem 5/FBI Records")
                                and os.path.exists("Problem 5/FBI Records/Suspects")
                                and os.path.exists("Problem 5/FBI Records/Evidence")
                                and os.path.exists(
                                    "Problem 5/FBI Records/Suspects/names.txt"
                                )
                                and os.path.exists(
                                    "Problem 5/FBI Records/Evidence/witnesses.txt"
                                )
                                and os.path.exists(
                                    "Problem 5/FBI Records/Evidence/murder_weapons.txt"
                                )
                                and os.path.exists(
                                    "Problem 5/FBI Records/Evidence/locations.txt"
                                )
                            ):
                                print("Correct!")
                                correct_status[choice] = True
                                ...
                                print(
                                    "The FBI Records folder isn't properly structured! Please try again."
                                )
                        else:
